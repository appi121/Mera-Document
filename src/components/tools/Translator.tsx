...
import { ArrowLeft, ArrowRightLeft, Copy, Volume2, Sparkles, Check } from 'lucide-react';
...
export const Translator: React.FC<TranslatorProps> = ({ lang, onBack }) => {
  ...
  const sampleTexts = {
    'hi-en': 'मुझे बैंक लोन प्रक्रिया के लिए आय प्रमाण पत्र की आवश्यकता है।',
    'en-hi': 'I am applying for a new electricity connection for my residence.'
  };
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <Card className="border-orange-200 shadow-md">
        <CardHeader className="bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-t-lg">
          ...
          </Card<dyad-write path="src/components/tools/Translator.tsx" description="Hindi to English & English to Hindi AI translation tool">
import React, { useState } from 'react';
import { Language } from '@/types/document';
import { Button } from '@/components/ui/button';
import { Textarea } from '@/components/ui/textarea';
