...
export const OcrExtractor: React.FC<OcrExtractorProps> = ({ lang, onBack }) => {
  ...
  // Verified sample data for manual preset load
  ...
  const handleExtract = async () => {
    ...
    try {
      ...
      if (result.formattedText.trim()) {
        ...
        showSuccess(lang === 'hi' ? 'नई फोटो से टेबल और डाटा सफलतापूर्वक एक्सट्रेक्ट हो गया!' : 'New photo table extracted successfully!');
      } else {
        setExtractedText(
          lang === 'hi' 
  ...
  const handleDownloadWord = () => {
    if (!extractedText) return;
    downloadWordDoc(`Document_${Date.now()}.doc`, extractedText, 'Document');
...
<body>
  <table>
    ...
    downloadFile(blob, `Table_Sheet_${Date.now()}.xls`, 'application/vnd.ms-excel');
    showSuccess(lang === 'hi' ? 'एक्सेल (.xls) शीट डाउनलोड हुई!' : 'Excel Table downloaded!');
  };
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-3 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-bold text-gray-900 text-xs sm:text-sm">
                  {lang === 'hi' ? 'नमूना: कक्षा 10 वीं बोर्ड बालिकाओं की टॉप 10 सूची' : 'Sample: Class 10th Board Top 10 List'}
                </p>
                <p className="text-[11px] text-gray-600">
                  {lang === 'hi' ? 'यदि आप नमूना जांचना चाहते हैं तो इस बटन पर क्लिक करें' : 'Click to load sample board list preset'}
                </p>
              </div>
            </div>
            ...
            <Button
              ...
              variant="outline"
              className="border-orange-300 text-orange-800 hover:bg-orange-100 text-xs font-bold px-4 py-2 rounded-xl shrink-0 gap-1.5 shadow-sm"
            >
              <CheckCircle2 className="w-4 h-4 text-orange-600" />
              {lang === 'hi' ? 'नमूना डाटा लोड करें' : 'Load Sample Data'}
            </Button>
          </div>
            ...
            <div className="lg:col-span-5 space-y-4">
                ...
                {previewUrl ? (
                  ...
                  <>
                    ...
                    <p className="font-bold text-gray-800 text-sm mb-1">
                      {lang === 'hi' ? 'नई फोटो या कागज़ अपलोड करें' : 'Upload New Photo'}
                    </p>
              ...
              >
                ...
                {loading 
                  ...
                  : (lang === 'hi' ? 'नई फोटो स्कैन करें' : 'Scan Uploaded Photo')}
              </Button>
            </div>
            ...
            <div className="lg:col-span-7 space-y-3">
              <Tabs defaultValue="table-view" className="w-full">
                <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2 mb-2">
                  ...
                  {extractedText && (
                    <div className="flex flex-wrap gap-1.<dyad-write path="src/components/tools/OcrExtractor.tsx" description="Completed OcrExtractor component with complete table editor, preview tabs and Excel export functionality">
import React, { useState } from 'react';
import { Language } from '@/types/document';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from '@/components/ui/card';
              ...
              <Tabs defaultValue="table-view" className="w-full">
                ...
                <TabsContent value="text-view">
                  <Textarea 
                    ...
                    placeholder={lang === 'hi' ? 'फोटो अपलोड करके "नई फोटो स्कैन करें" बटन दबाएं...' : 'Upload photo and click scan...'}
